...
// in function modifyArray, "b" points to the original array "a" in momory
void modifyArray(int b[], size_t size) {
...
void modifyElement(int e) {
    e *= 2; // multuply parameter by 2
    printf("Value in modifyElement is %d\n", e);
}

// infunction tryToModifyArray, array b is const, so it cannot be
